...
const banner = 'https://raw.githubusercontent.com/kuralarasu23/react-userpanel-1/refs/heads/main/src/images/shirtbanner.jpg'
...
function Shirts() {
  ...
  const filterdata = data.filter(items => items.listingType == "shirts")
